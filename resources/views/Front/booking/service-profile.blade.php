        ...
        <div class="site-main">
            ...
            <div class="sidebar ttm-sidebar-left ttm-bgcolor-grey break-991-colum clearfix">
                <div class="container">
                                ...
                                <div class="doctor-widget">
                                    <div class="doc-info-left">
                                        <div class="doctor-img">
                                            <img src="images/11.png" class="img-fluid" alt="User Image">
                                        </div>
                                        <div class="doc-info-cont">
                                            <h4 class="doc-name">Dr. Darren Elder</h4>
                                            <p class="doc-speciality">BDS, MDS - Oral & Maxillofacial Surgery</p>
                                            <p class="doc-department"><img src="images/11.png" class="img-fluid" alt="Speciality">Dentist</p>
                                            <div class="rating">
                                            ...
                                            <div class="clinic-details">
                                                ...
                                                <ul class="clinic-gallery">
                                                    <li>
                                                        <a href="images/11.png" data-fancybox="gallery">
                                                            <img src="images/11.png" alt="Feature">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="images/11.png" data-fancybox="gallery">
                                                            <img src="images/11.png" alt="Feature Image">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="images/11.png" data-fancybox="gallery">
                    ...
                    <!-- Doctor Details Tab -->
                    <div class="card">
                        <div class="card-body pt-0 pb-15">
