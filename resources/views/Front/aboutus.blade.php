...
<body>
    ...
    <div class="site-main">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-sm-12">
                        <div class="pl-20">
                            ...
                            <p><strong>نحن فريق من الخبراء المحترفين والمهرة في جميع المجالات المحلية. نحن نقدم مجموعة واسعة من الخدمات وفي نفس الوقت يسعدنا دائمًا مساعدتك في أي احتياجات منزلية غير تقليدية:</strong></p>
                            <p class="mb-30">نعمل على ضمان راحة الأشخاص في منازلهم ، وتقديم أفضل وأسرع مساعدة بأسعار عادلة. نحن ندافع عن الجودة والأمان والمصداقية ، لذلك يمكنك التأكد من عملنا. في البداية بدأنا الآن نحن فخورون بقدرتنا على مساعدة الأشخاص في اللحام والتنقل والتنظيف الجاف وتنسيق الحدائق وحتى مكافحة الآفات.</p>
                            <p>Company CEO : Same Williamson</p>
                            <span><img src="images/author-sign.png" alt="ttm_single_image-wrapper"></span>
                        </div>
                    </div>
                </div><!-- row end-->
            </div>
                    ...
                    <div class="col-md-3">
                        <div class="ttm-fid inside ttm-fid-view-topicon">
                            ...
                            <div class="ttm-fid-contents">
                                ...
                                <h3 class="ttm-fid-title"><span>Expert Worker<br></span></h3>
                            </div><!-- ttm-fid-contents end -->
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="ttm-fid inside ttm-fid-view-topicon">
                            ...
                            <div class="ttm-fid-contents">
                                ...
                                <h3 class="ttm-fid-title"><span>Award Winner<br></span></h3>
                            </div><!-- ttm-fid-contents end-->
                        </div>
                    </div>
                </div>
        ...
        <!--only-title-section-->
        <section class="ttm-row only-title-section style2 ttm-bgcolor-darkgrey clearfix">
            <div class="container">
                <!-- row -->
                <!-- row -->
                <div class="row">
