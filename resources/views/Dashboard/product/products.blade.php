                                ...
                                <div class="card card-secondary">
                                    ...
                                    <div class="card-body" style="direction: rtl;">
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                          ...
                                          <li class="nav-item">
                                            <a class="nav-link " id="{{($Category->id)}}" data-toggle="tab" href="#{{($Category->name)}}" role="tab"
                                              aria-controls="{{($Category->name)}}" aria-selected="true"> {{($Category->name)}}</a>
                                          </li>
                                          {{-- <li class="nav-item">
                                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                                              aria-controls="profile" aria-selected="false">كهرباء</a>
                                          </li>
                                          <li class="nav-item">
                                            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                                              aria-controls="contact" aria-selected="false">نقاشة</a>
                                          </li> --}}
                                          @endforeach
                                            @endif
                                        </ul>
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            @if ($category && $category->count() > 0)
                                                @foreach ($category as $Category )
                                          <div class="tab-pane fade show active" id="{{($Category->name)}}" role="tabpanel" aria-labelledby="{{($Category->id)}}">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($suppliers as $Suppliers)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if ($Suppliers->state == 0)
                                                                        <div class="badge badge-danger">غير نشط</div>
                                                                    @elseif($Suppliers->state == 1)
                                                                        <div class="badge badge-success">نشط</div>
                                                                    @endif

                                                                </td>
                                                                <td>{{ $Suppliers->department->name }}</td>
                                                                <td >
                                                                    <div style="font-weight: 800; color: black;">
                                                                        {{ $Suppliers->start_count }}</td>
                                                                    </div>
                                                                <td >
                                                                    <div style="font-weight: 800; color: #dc3545;">
                                                                        {{ $Suppliers->end_count }}</td>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="btn-group dropup">
                                                                        ...
                                                                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                                                            ...
                                                                            <a class="dropdown-item" href="">فواتير</a>
