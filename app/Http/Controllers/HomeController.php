...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Dashboard.dashboard',compact('orderCharts','users'));
    }
    ...
    public function userChart()
    {
        ...
        for ($i = 0; $i < 12; $i++)
        {
            $d =  Service::whereMonth('created_at', $now->month)->whereYear('created_at', $now->year)->get();
            $s =  User::whereMonth('created_at', $now->month)->whereYear('created_at', $now->year)->get();
